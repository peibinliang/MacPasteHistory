...
- [ ] 3.6 Test large image copy.
  ...
  - 当前进展：`scripts/release-smoke-test.sh` 已在 Release 包中验证 1024x768 模拟 PNG 可捕获，且原图、缩略图路径和尺寸元数据已持久化；超限图片跳过和人工恢复仍待验证。
